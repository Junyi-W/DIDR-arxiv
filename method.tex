...
% % \begin{figure}[!t]
% \begin{wrapfigure}{tr}{0.66\linewidth}
% \vspace{-0.16in}
% \centering
% \includegraphics[width=0.99\linewidth]{pictures/Pipeline.png}
% \caption{\textbf{The \textsc{Didr} training framework.} \textbf{Stage I (TA):} $s_\psi$ tracks the generator's marginals via DSM. \textbf{Stage II (Generator):} $g_\theta$ is updated toward the reward-tilted target score $\tilde{s}_{\mathrm{ref}}+s_r$.}
% \label{fig:workflow}
% \end{wrapfigure}
